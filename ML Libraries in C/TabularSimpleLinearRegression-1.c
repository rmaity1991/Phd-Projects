...
void Linear_Regression(float **X, float *Y, int feature_count, int value_count, float *_coeff, float *_intercept)
{
    ...
    *_coeff = (((Y_Summation * X2_Summation) - (X_Summation * XY_Summation)) / ((value_count * X2_Summation) - pow(X_Summation, 2)));

    *_intercept = (((value_count * XY_Summation) - (X_Summation * Y_Summation)) / ((value_count * X2_Summation) - pow(X_Summation, 2)));
}
